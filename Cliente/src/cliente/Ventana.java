...
public class Ventana implements ActionListener {
    ...
    private ArrayList<JTextPane> chatPersona;
    ...
    public Ventana(int operacion) {
        ...
        while (Nombre.isEmpty()) {
            Nombre = JOptionPane.showInputDialog("Ingresa nombre usuario");
        }
        ventana = new JFrame();
    ...
    private void inicializarComponentes() {
        panel = new JPanel();
        JLabel titulo = new JLabel("chats: " + Nombre);
    ...
    private void newChat(String nombre) {
        ...
        JTextPane conversacion = new JTextPane();
    ...
    public void setNewMessage(String mensaje) {
        if (mensaje.contains("<contactos>")) {
            ...
            //Emojis
            mensaje = mensaje.replace("Homero", "<b><img src=http://tusimagenesde.com/wp-content/uploads/2015/01/gifs-animados-5.gif></b>");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (boton.getActionCommand().equals("Nuevo chat privado")) {
            if (contactos.toArray().length == 0) {
                JOptionPane.showMessageDialog(null, "Necesita mas contactos en sesion", "Contactos", JOptionPane.ERROR_MESSAGE);
            } else {
